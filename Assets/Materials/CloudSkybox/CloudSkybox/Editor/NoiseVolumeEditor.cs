...
namespace CloudSkybox
{
    ...
    public class NoiseVolumeEditor : Editor
    {
        ...
        [MenuItem("A/Get Render Settings")]
        public static void GetRenderSettings()
        {
            var t = typeof(RenderSettings);
            var m = t.GetMethod("GetRenderSettings", BindingFlags.Default | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static);
            var obj = m.Invoke(null, null) as Object;
            Debug.Log(obj.GetType());
            obj.hideFlags = HideFlags.None;
            Selection.activeObject = obj;
            // var w = Object.FindObjectOfType<TimeOfDayManager>();
            // w._skybox = (RenderSettings) obj;
